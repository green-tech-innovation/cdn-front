...
import { menuItemsCDN } from "./menu";
import { menuItemsPatner } from "./menu";
import { menuItemsSector } from "./menu";
...
export default {
  data() {
    return {
      menuItems: localStorage.getItem(Helper.WHO_CONNECTED) == "CDN" ? menuItemsCDN : (localStorage.getItem(Helper.WHO_CONNECTED) == "SECTOR" ? menuItemsSector : menuItemsPatner),
      menuData: null,
    };
  },
  mounted: function () {
